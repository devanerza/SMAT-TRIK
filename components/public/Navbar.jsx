...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#F9FAFB]/90 backdrop-blur-md border-b border-slate-100">
      ...
      <div
        className={`absolute top-full left-0 right-0 z-40 bg-[#F9FAFB] border-b border-slate-200/60 shadow-lg transition-all duration-300 ease-in-out origin-top md:hidden ${
          menuOpen ? 'max-h-[400px] opacity-100 visible' : 'max-h-0 opacity-0 invisible overflow-hidden pointer-events-none'
        }`}
      >
