        ...
        <Layout>
          ...
          <section className="py-20 bg-[#F3F4F6]/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {/* Banner block: Siap Kirim Seluruh Indonesia */}
              <div className="bg-gradient-to-r from-[#8C3005] to-[#B43C02] rounded-3xl p-8 sm:p-10 shadow-lg text-white relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="relative z-10 max-w-2xl">
                  ...
                  <p className="text-orange-100 text-sm sm:text-base leading-relaxed">
                    Distribusi logistik terpercaya menjamin ketersediaan stok Smat-trik Freon di mana pun fasilitas industri Anda berada.
                  </p>
                </div>
                ...
                <div className="relative z-10 shrink-0">
                  <Link 
                    href="/order" 
                    className="inline-flex items-center gap-2 font-bold text-sm sm:text-base text-white border-b-2 border-white pb-0.5 hover:text-orange-200 hover:border-orange-200 transition-colors"
                  >
                    Cek Ketersediaan Wilayah
